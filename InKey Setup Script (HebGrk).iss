...
AppName=InKey
AppVerName=InKey 0.105
VersionInfoVersion=0.1.05
...
OutputBaseFilename=InKey Setup (HebGrk)
Compression=lzma
...
Source: "InKey\GreekNT\*"; DestDir: "{app}\GreekNT"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "InKey\Hebrew\*"; DestDir: "{app}\Hebrew"; Flags: ignoreversion recursesubdirs createallsubdirs
