...
AutoAddSmoothBreathingIfNeeded() {
	...
	loop {
		...
		else if ((cc = 0x3B1) or (cc = 0x3B5) or (cc = 0x3B7) or (cc = 0x3B9) or (cc = 0x3BF) or (cc = 0x3C5) or (cc = 0x3C9) or (cc = 0x1F70) or (cc = 0x1F71) or (cc = 0x1FB2) or (cc = 0x1FB3) or (cc = 0x1FB4) or (cc = 0x1FB6) or (cc = 0x1FB7) or (cc = 0x1F72) or (cc = 0x1F73) or (cc = 0x1F74) or (cc = 0x1F75) or (cc = 0x1FC2) or (cc = 0x1FC3) or (cc = 0x1FC4) or (cc = 0x1FC6) or (cc = 0x1FC7) or (cc = 0x1F76) or (cc = 0x1F77) or (cc = 0x03CA) or (cc = 0x1FD2) or (cc = 0x1FD3) or (cc = 0x1FD6) or (cc = 0x1FD7) or (cc = 0x1F78) or (cc = 0x1F79) or (cc = 0x1F7A) or (cc = 0x1F7B) or (cc = 0x03CB) or (cc = 0x1FE2) or (cc = 0x1FE3) or (cc = 0x1FE6) or (cc = 0x1FE7) or (cc = 0x1F7C) or (cc = 0x1F7D) or (cc = 0x1FF2) or (cc = 0x1FF3) or (cc = 0x1FF4) or (cc = 0x1FF6) or (cc = 0x1FF7)) ; αεηιουωὰάᾲᾳᾴᾶᾷὲέὴήῂῃῄῆῇὶίϊῒΐῖῗὸόὺύϋῢΰῦῧὼώῲῳῴῶῷ
		{
