...
Menu, Tray, Icon, OpenShapeVwl.bmp

IniRead, K_Params, OpenShape.kbd.ini, Keyboard, Params, %A_Space%

;*** This section is copied directly from NigOddVowels.ahk.  Updates there should be copied here, too.
...
IniWrite, %Params%, OpenShape.kbd.ini, Keyboard, Params
ExitApp
