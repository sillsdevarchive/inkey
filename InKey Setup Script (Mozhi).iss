...
#define InKeyVer GetFileVersion("InKey\InKey.exe")
...
Source: ".install\mozhi\InKey.ini"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "InKey\Mlym-Mozhi\*"; DestDir: "{app}\Mlym-Mozhi"; Flags: ignoreversion recursesubdirs createallsubdirs
