...
Source: "InKeyLive\Mlym-Mozhi\Mozhi.kbd.ini"; DestDir: "{app}\Mlym-Mozhi"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "InKeyLive\Mlym-Mozhi\mozhi.png"; DestDir: "{app}\Mlym-Mozhi"; Flags: ignoreversion recursesubdirs createallsubdirs
;Source: "InKeyLive\Indic-WinScript\*"; DestDir: "{app}\IPA"; Flags: ignoreversion recursesubdirs createallsubdirs
;Source: "InKeyLive\ExtendedUS\*"; DestDir: "{app}\ExtendedUS"; Flags: ignoreversion recursesubdirs createallsubdirs
;Source: "InKeyLive\Generic\*"; DestDir: "{app}\Generic"; Flags: ignoreversion recursesubdirs createallsubdirs
